...
//2. A class name should always start with an uppercase letter
//3. All the programs in java will have src as its root folder. You can add package (folder) inside the src folder and
