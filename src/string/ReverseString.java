...
// We can then initiate the index with the string length-1 (as the s.length will return 7, but index starts from 0), and iterate reverse till the starting index of the string
